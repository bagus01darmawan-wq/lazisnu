import { pgTable, uuid, varchar, text, timestamp, boolean, decimal, integer, json, pgEnum, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const collectionSummaries = pgTable('collection_summaries', {
  ...
  cashAmount: decimal('cash_amount', { precision: 15, scale: 2 }).default('0').notNull(),
  transferCount: integer('transfer_count').default(0).notNull(),
  transferAmount: decimal('transfer_amount', { precision: 15, scale: 2 }).default('0').notNull(),
